...
const Hero = () => {
  return (
    <div className="app__hero h-[calc(100vh_-_113px)] w-full flex flex-col justify-center items-center bg-center bg-black bg-opacity-10 bg-blend-overlay" style={{ backgroundImage: `url(${images.communication.src})` }}>
