  ...
  return (
    <>
      ...
      >
        ...
        <p className="mb-8 ml-16 text-left text-lg text-white">
        ...
        <div className="flex">
          <div className="ml-16 flex items-center">
            <FaPhoneAlt className="mr-5 text-3xl text-white" />
            <div className="flex flex-col">
              <h6 className="mr-5 text-base uppercase text-white opacity-75">
                Phone
              </h6>
              <p className="text-2xl text-white">912 658 932</p>
            </div>
          </div>

          <div className="ml-16 flex items-center">
            <FaRegEnvelope className="mr-5 text-3xl text-white" />
            <div className="flex flex-col">
              <h6 className="mr-5 text-base uppercase text-white opacity-75">
                E-MAIL
              </h6>
              <p className="text-2xl text-white">geral@domain.com</p>
            </div>
          </div>
        </div>
      </div>
