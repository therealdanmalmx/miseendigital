  ...
  return (
    <>
      ...
      <div className="app__services flex flex-col items-center pt-20">
        ...
        {/* Services items */}
        <div className="app__profiles overflow-hidden flex flex-col cursor-pointer flex-wrap items-center">
          {abouts.map((about, index) => (
            <Link
              ...
              key={about._id}
            >
              <div className="relative overflow-hidden w-[325px] h-96 my-2 md:my-8 md:h-[450px] md:w-9/12">
                {about.imgUrl && (
                ...
                <div className="w-1/2 bg-black opacity-60 h-full"></div>
                  <h2 className="bold-text bg-black px-4 py-2 absolute z-10 bottom-5 left-5 text-white font-bold">
                    {about.title}
                  </h2>
              </div>
            </Link>
